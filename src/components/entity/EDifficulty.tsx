...
import { OpDifficulty } from 'src/models/operation'
import { OpDifficultyBitFlag } from '../../models/operation'
...
const DifficultyTag: FC<{
  ...
  return (
    ...
    >
      <Tag
        className={clsx(
          'transition border border-solid !text-xs cursor-help tracking-tight !px-2 !py-1 leading-none !min-h-0',
          hardLevel
      ...
      <DifficultyTag
        tooltip={
          <div className="flex flex-col">
            <span>
              本作业并未支持难度支持标识，请自行根据作业的文字描述判断其所支持的作业难度等级。通常来说，未写明支持难度的作业均仅支持普通难度作战。
            </span>
